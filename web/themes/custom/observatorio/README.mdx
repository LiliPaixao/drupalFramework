...
observatorio theme uses [Webpack](https://webpack.js.org) to compile and
bundle SASS and JS.
...
Go to the root of observatorio theme and run the following commands:
`nvm use`
...
`drush en observatorio -y`
`drush config-set system.theme default observatorio -y`
